...
export class Backend implements backendInterface {
    ...
    async checkTripExists(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.checkTripExists();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getCost(arg0: number, arg1: number): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getCost(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDistance(): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.getDistance();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFinalTripStep(arg0: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getFinalTripStep(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTime(arg0: number): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.getTime(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async startBooking(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.startBooking();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async verifyOTP(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
